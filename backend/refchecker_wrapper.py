...
def _shared_title_similarity(a: str, b: str):
    """Use the same title scorer as live verification on cache hits."""
    try:
...
def _diff_cited_vs_truth(reference, truth):
    ...
    # cached paper. Cache replay must use the same title scorer and acceptance
    # threshold as the live checkers so WebUI, CLI, and bulk results agree.
