...
from service_core.utils.doi_utils import extract_doi_from_url, compare_dois, construct_doi_url
from service_core.utils.error_utils import create_author_error, create_doi_error, create_venue_warning, format_title_mismatch
from service_core.utils.text_utils import normalize_author_name, normalize_paper_title, is_name_match, compare_authors, calculate_title_similarity, compare_titles_with_latex_cleaning, strip_latex_commands, are_venues_substantially_different, is_missing_title_spacing_artifact
from service_core.utils.url_utils import extract_arxiv_id_from_url, get_best_available_url, construct_semantic_scholar_url
from service_core.utils.db_utils import process_semantic_scholar_result, process_semantic_scholar_results
from service_core.config.settings import get_config
from service_core.checkers.arxiv_citation import ArXivCitationChecker
from service_core.database.local_database_updater import repair_local_database_schema
...
class LocalNonArxivReferenceChecker:
    ...
    def verify_reference(self, reference: Dict[str, Any]) -> Tuple[Optional[Dict[str, Any]], List[Dict[str, Any]], Optional[str]]:
        ...
        # Reject truncated/partial DOIs (e.g., "10.1016/j")
        from service_core.utils.doi_utils import is_valid_doi_format
