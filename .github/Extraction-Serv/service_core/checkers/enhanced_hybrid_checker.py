...
from service_core.utils.database_config import DATABASE_LABELS, DATABASE_LOOKUP_ORDER
...
class EnhancedHybridReferenceChecker:
    ...
    def _handle_arxiv_result(self, result, reference):
        ...
        if has_title_error:
            ...
            from service_core.utils.text_utils import compare_titles_with_latex_cleaning
    ...
    def _check_arxiv_id_mismatch(self, reference: Dict[str, Any],
        ...
        """
        from service_core.utils.url_utils import extract_arxiv_id_from_url
        from service_core.utils.text_utils import calculate_title_similarity, compare_authors
    ...
    def normalize_paper_title(self, title: str) -> str:
        ...
        if self.semantic_scholar:
            ...
            from service_core.utils.text_utils import normalize_paper_title as normalize_title
    ...
    def compare_authors(self, cited_authors: List[str], correct_authors: List[Any]) -> Tuple[bool, str]:
        ...
        """
        from service_core.utils.text_utils import compare_authors
