...
from service_core.utils.arxiv_rate_limiter import ArXivRateLimiter, arxiv_cached_get
from service_core.utils.text_utils import (
    normalize_text,
    compare_authors,
    compare_titles_with_latex_cleaning,
    strip_latex_commands,
)
from service_core.utils.error_utils import format_title_mismatch, validate_year
