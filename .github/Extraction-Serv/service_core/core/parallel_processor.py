...
from service_core.utils.text_utils import deduplicate_urls
                ...
                with self.buffer_lock:
                    while self.next_print_index in self.result_buffer:
                        ...
                        if current_result.errors:
                            from service_core.core.hallucination_policy import has_real_raw_errors
                            if has_real_raw_errors(current_result.errors):
