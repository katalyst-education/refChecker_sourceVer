              ...
              <div>
                ...
                <div className="text-sm" style={{ color: 'var(--color-text-secondary)' }}>
                  ...
                  {ms && !ms.installed && !ms.deps_available &&
                    'Inference runtime not installed — install torch + transformers below for the managed model, or use the LLM-judge / API engine. ONNX Runtime requires a model.onnx artifact.'}
                </div>
                <div className="text-xs mt-1" style={{ color: 'var(--color-text-muted, #94a3b8)' }}>
                  Model:{' '}
                  <a
